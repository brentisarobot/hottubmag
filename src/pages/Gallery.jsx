...
const Gallery = () => {
    ...
    return (
        ...
        <main className="flex h-screen bg-yellow-200">
            ...
            <h1 className="text-3xl">Hello, {name? name : 'guest'}!</h1>
            <input type="text" className="p-2" placeholder="What's your name?" value={name} onChange={(e)=>setName(e.target.value)}/>

                <h1 className="text-3xl text-center mb-8">Gallery</h1>
                <p className="mb-8">
